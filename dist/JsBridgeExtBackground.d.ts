...
import { IInjectedProviderNamesStrings, IJsBridgeConfig, IJsBridgeMessagePayload } from 'cross-inpage-provider-types';
...
declare class JsBridgeExtBackground extends JsBridgeBase {
    ...
    requestToOffscreen(data: unknown): Promise<import("cross-inpage-provider-types").IJsonRpcResponse<unknown>> | undefined;
