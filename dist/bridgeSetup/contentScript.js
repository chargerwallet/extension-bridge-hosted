import { consts, isLegacyExtMessage, appDebugLogger, injectedFactory, } from 'cross-inpage-provider-core';
import messagePort from '../extensionMessagePort';
import { commonLogger } from 'cross-inpage-provider-core';
...
function setupMessagePort(options = {}) {
    ...
    messagePort.connect({
        ...
        onConnect(port) {
            ...
            return () => {
                commonLogger.error('CHARGERWALLET: lost connection to hosted bridge. You should reload page to establish a new connection.');
