export declare const bridgeSetup: {
    contentScript: {
        ...
        setupMessagePort: (options?: import("cross-inpage-provider-types").IOptionsWithDebugLogger) => void;
    };
    ui: {
    ...
    background: {
        createHostBridge: ({ receiveHandler }: {
            receiveHandler: import("cross-inpage-provider-types").IJsBridgeReceiveHandler;
